...
<%
  if (request.getAttribute("ip_address") != null) {
        out.println("<div class=\"w3-panel w3-green w3-display-container w3-card-4 w3-round\">\n" +
                ...
                "   <h5>IP '" + request.getAttribute("ip_address") + "' deleted!</h5>\n" +
                "</div>");
  }
%>
<div class="w3-card-4">
...
<form method="post" class="w3-selection w3-light-grey w3-padding">
    <label>Remove IP address:
        <input type="text" name="remove_ip" class="w3-input w3-animate-input w3-border w3-round-large" style="width: 30%"><br />
    </label>
